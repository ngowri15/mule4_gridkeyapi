//*****************************************************************************
// Name            : Alert Email Enable/Disable
//
...
// Description
// -----------
// This file enables or disables the email alerting for the given username
//
//*****************************************************************************
...
public class AlertEmailEnableDisable {
	...
	public Object onCall(Map<String, String> uriAttributes, Map<Object, Object> cassConnection) throws Exception {
		...
		// Set the email address based upon the enabled state
		String emailAddress = state.contains("enabled") ? username : "";
